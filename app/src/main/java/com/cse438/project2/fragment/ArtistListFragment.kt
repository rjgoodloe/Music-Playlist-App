...
class ArtistListFragment(context: Context, query: String): Fragment() {
    ...
    override fun onStart() {
        ...
        viewModel.getArtistsByQueryText(queryString).observe(this, observer)
    ...
    inner class ArtistListAdapter: RecyclerView.Adapter<ArtistListAdapter.ArtistListViewHolder>() {
        ...
        override fun onBindViewHolder(p0: ArtistListViewHolder, p1: Int) {
            ...
            if (artistImages.size == 0 || artistImages[index].isEmpty()) {
                ...
                Picasso.with(this@ArtistListFragment.context)
            ...
            p0.itemView.setOnClickListener {
                (activity as MainActivity).fm.beginTransaction()
                    .addToBackStack(null)
                    .replace(R.id.frag_placeholder, TracksByArtistListFragment(this@ArtistListFragment.parentContext, artist.getName()))
                    .commit()
            }
        }
